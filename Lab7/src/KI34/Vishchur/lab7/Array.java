...
public class Array<T extends Shape> {
    ...
    public int getthelargestcubevolume()
    {
    int result1 = 0;
    for(int i=0; i<storage.size(); i++)
    {
    	result1 = storage.get(i).getVolume();
    }
    return result1;
    }
    public void getthelargestspherevolume()
    {
    int result2 = 0;
    for(int i=0; i<storage.size(); i++)
    {
    	if(result2!=storage.get(i).getmaxvalue())
    	{
    	result2 = storage.get(i).getmaxvalue();
